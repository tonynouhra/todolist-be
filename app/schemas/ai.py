...
class SubtaskGenerationRequest(BaseSchema):
    ...
    max_subtasks: int = Field(default=5, ge=3, le=7, description="Maximum number of subtasks to generate")
...
class GeneratedSubtask(BaseSchema):
    ...
    estimated_time: Optional[str] = Field(None, description="Estimated time to complete (e.g., '30 minutes', '2 hours')")
