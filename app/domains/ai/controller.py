        ...
        return JSONResponse(
            ...
            content=ResponseSchema(
                ...
                data=AIErrorResponse(
                    ...
                    error_message=str(e),
                    suggestions=["Check AI service configuration", "Contact administrator"]
                ).model_dump()
            ).model_dump()
        )
        ...
        return JSONResponse(
            ...
            content=ResponseSchema(
                ...
                data=AIErrorResponse(
                    ...
                    error_message=str(e),
                    suggestions=["Try again later", "Upgrade service plan if available"]
                ).model_dump()
            ).model_dump()
        )
        ...
        return JSONResponse(
            ...
            content=ResponseSchema(
                ...
                data=AIErrorResponse(
                    ...
                    error_message=str(e),
                    suggestions=["Try again with a simpler request", "Check network connectivity"]
                ).model_dump()
            ).model_dump()
        )
